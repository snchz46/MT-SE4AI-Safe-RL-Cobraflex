...
\newcommand{\figmissing}[3][t]{%
	\begin{figure}[#1]
		\centering
		\fbox{\parbox[c][40mm][c]{0.9\textwidth}{\centering\sffamily\small
			\textcolor{ubred}{Figure not available on this host}\\[0.4em]
			\texttt{#2}\\[0.4em]
			\footnotesize regenerate on the compute host}}
		\caption{#3}
	\end{figure}
}
...
%
% Usage:  \begin{widetable}{@{}L{12mm}L{45mm}...@{}}  ... \end{widetable}
...
% Width of a wide table, for convenience in column arithmetic.
\newlength{\wtw}
\AtBeginDocument{\setlength{\wtw}{\dimexpr\marginparwidth+\textwidth+\marginparsep\relax}}
