...
El sistema de referencia **no añade nodos: especializa el entorno**. El mismo entorno de entrenamiento sirve a ambos tracks y la rama de cámara se activa con un conmutador de configuración. Cuatro decisiones técnicas merecen registro.
