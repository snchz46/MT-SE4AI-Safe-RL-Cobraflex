...
% ---------------------------------------------------------------------------
% Repository provenance. These are printed on the title page so that any
% printed copy states which commit of the research repository it was built
% from -- the same reproducibility discipline the thesis argues for.
% ---------------------------------------------------------------------------
\def\treporurl{https://github.com/} % TODO: fill in if the repo is published
\def\tbuildnote{built from manuscript/draft\_v5\_en}
