...
| Track / wheelbase / wheel radius | **0.153 / 0.154 / 0.03725 m** | Confirms the sim geometry. The plugin's `wheel_separation` 0.154 is the *wheelbase*, not the track — a 0.65 % semantic error, deliberately not corrected (docs/14 §2.3). |
