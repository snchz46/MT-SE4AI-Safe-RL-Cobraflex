...
**(f) Sobre una regla que el hardware sí interrogó.** El techo de velocidad se declara satisfecho aquí sin haber sido activado ni una vez, y el Capítulo 9 añade dos precisiones que la Fase 5 midió y que acotan esa casilla sin re-puntuarla. La primera: en la configuración física desplegada la regla no puede activarse sobre movimiento comandado, porque su techo de curva (0,25 m/s) queda por encima del cap desplegado (0,22 m/s); lo que en simulación era un hueco de cobertura es, en la curva más cerrada del circuito real, una regla que no protege un caso que existe. La segunda, y es peor: la regla sí llegó a activarse —58 y 40 ciclos en las dos corridas enjauladas que sobreviven a la auditoría—, el 100 % de las veces sobre artefactos de velocidad del sensor de pose (0,25–1,30 m/s reportados, imposibles bajo su propia potencia), y en una de ellas esos disparos espurios bloquearon la vía de rearme de la regla que ellos mismos habían levantado. Para esta declaración eso significa una cosa concreta y acotada: el veredicto de ese requisito descansa por completo en que su condición de disparo no se alcanzó en simulación, y no en evidencia de que la regla intervenga correctamente cuando se alcanza. Es el requisito con el respaldo más débil de la tabla, y se señala como tal.
