...
- **¹ SR-006 — Satisfecho sobre su propia métrica (D-39).** Al agregarlo de forma gruesa sobre «todos los escenarios», heredaba un fallo de proporción que no tenía nada que ver con la suavidad. Por eso se puntúa directamente sobre su métrica. En los pasos que de verdad controla el limitador (sin una regla de seguridad por encima ni emergencia), la variación por ciclo del mando aplicado respeta `δ_max = 0,15` en las 840 corridas de enforcement que tienen pasos de ese tipo; las 105 restantes terminan en emergencia y no aportan muestra. En monitorización solo lo cumplen 263 de 945 (27,8 %), con una variación por ciclo máxima de 2,0. Es la medida más directa de lo que vale C-06. El método se aplicó primero a la campaña anterior (559/559 en enforcement frente al 67,6 % en monitorización, peor caso 0,43); las cifras de arriba son las del veredicto de referencia.
...
- **⁶ SC-PERT-11 / 12 / 13** (marcas desgastadas, degradación de imagen y las dos combinadas) amplían la familia adversa de SR-012 / SR-014 y dan a SR-013 su segundo escenario adverso. En la campaña del veredicto de referencia puntúan 30/30, 40/40 y 40/40 en enforcement, frente a 30/30, 32/40 y 20/40 en monitorización; en el registro congelado de la puerta GE4-V2 las cifras de monitorización eran 0/30, 23/40 y 0/40.
