...
def normalize_sr(sr: Dict[str, str]) -> Dict[str, str]:
    ...
    column_mapping = {
        ...
        'implementation_type': ['implementation_type', 'implementation type', 'implementation', 'implemented_by', 'cage_rule', 'cage rule', 'cage rules', 'cage_rules', 'related_cage_rules'],
        'criticality': ['criticality', 'criticidad', 'criticality_class', 'sr_class', 'class'],
