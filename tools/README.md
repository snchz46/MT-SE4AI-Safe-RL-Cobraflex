...
- `check_scenario_yaml.py` — validates scenario YAML files against the Phase-2 executable schema. Default mode accepts explicitly deferred stubs with warnings; use `--strict` to fail on those warnings in later scenario-library gates.
