...
Versión completa de la Tabla 2.1, con las veinte líneas de trabajo revisadas en el
Capítulo 2 evaluadas sobre los siete ejes de interés. `✓` indica cobertura sustantiva del
eje; `partial`, cobertura parcial; `–`, ausencia de tratamiento.
...
| Kuutti et al. (2019, 2021b) — safety cage AV (runtime + weak supervision) | partial | ✓ | – | – | – | – | – |
...
| Keswani & Bhattacharyya (2025) — SRPL evaluated on driving datasets | ✓ | – | – | – | – | – | – |
...
| Hawkins (2025) — PAS 8800 use case (BSI) | – | – | partial | ✓ | partial | – | partial |
| Sprockhoff et al. (2023) — MBSE | – | – | – | ✓ | ✓ | – | – |
| Ullrich et al. (2025) — expanded V-Model for AI | partial | partial | partial | ✓ | partial | partial | – |
