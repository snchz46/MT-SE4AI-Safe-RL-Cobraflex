...
**Algoritmo.** Una política entrenada con el método en política alcanza una recompensa media de 1755 hacia los 472 000 pasos (Figura 7.4) con meseta alta y estable, mientras el método fuera de política nunca supera ~200 y no llega a dominar el circuito. Techo de velocidad. Una comparación de una sola variable muestra que a 0,5 m/s la política pica en 654 y traza sucio —se pasa de las curvas cerradas— frente a 1421 a 0,22 m/s, donde las traza limpio.
