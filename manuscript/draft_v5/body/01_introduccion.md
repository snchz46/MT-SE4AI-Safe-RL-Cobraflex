...
- **C4 — Medición del gap sim-to-real** en peldaños cada vez más realistas: Gazebo (campaña de referencia) → un simulador más realista (Isaac Sim, PhysX + RTX) → la plataforma física. El tercer peldaño termina como puesta en marcha y no como campaña de resultados. Los Capítulos 9 y 10 lo dicen abiertamente en lugar de ocultarlo.
...
- **El peldaño físico termina como puesta en marcha.** La cadena de despliegue funciona en el vehículo real y da resultados de calibración y hallazgos estructurales. Sin embargo, no se ha puntuado ningún escenario sobre hardware y la cage nunca ha cambiado una acción allí. Por eso la columna física de la tabla de veredictos se marca como *no ejecutada* (§10.4), y todas las cifras de conducción del Capítulo 9 son preliminares. Es un límite de la evidencia, no del marco, y el texto lo dice allí donde importa.
