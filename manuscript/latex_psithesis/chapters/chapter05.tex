...
\figwide{fig_5_2_node_chain}{Node chain: perception, policy, cage, vehicle control and logging. The command of the policy never reaches the actuator without passing through the cage.}{5.2}
