...
\figwide{fig_ppo2d_action_distribution}{Distribution of the raw action at the start against the end of training, one panel per dimension. In steering, the initial all-or-nothing command dissolves (36.9\,\% $\rightarrow$ 7.1\,\% of saturated samples). In throttle, the evolution is the opposite, towards saturation (48.2\,\% $\rightarrow$ 89.6\,\%): the policy learns to ask for the ceiling almost always.}{7.5}
