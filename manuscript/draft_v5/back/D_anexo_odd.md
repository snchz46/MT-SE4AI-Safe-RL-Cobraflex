...
Tabla completa de parámetros de los cuatro dominios operacionales. Cada parámetro tiene un nombre, un valor para cada dominio y una procedencia. Cuando existe un parámetro con nombre, ninguna afirmación del texto sobre el dominio se apoya en una descripción cualitativa.
