...
<img src="../figures/fig_2_1_classical_rl_framework.png" alt="Figura 2.1 — The classical RL framework." width="400"/>

*Figura 2.1 — The classical RL framework (Source: Sutton and Barto 1998 [13]). The agent selects an action At at state St, in response to which it receives a corresponding reward R T +1 . The objective of the agent is to choose actions that maximize its reward over a long sequence of transitions.*
...
<img src="../figures/fig_2_2_safety_cage_idea.png" alt="Figura 2.2 — Safety Cage applied to the classical RL framework." width="400"/>

*Figura 2.2 — Safety Cage applied to the classical RL framework.*
